...
public class Gene implements Serializable {
	...
	public Gene(ParamType att, String name, String registerModbus, int minValue, int maxValue, String options) {
		this.lastChildRead = -1;
		this.paramType = att;
        this.registerModbus = registerModbus;
		switch (att) {
		case LAYOUT:
	...
	public Gene clone() {
		Gene gene = new Gene();
		gene.setId(this.id);
		gene.setRegisterModbus(this.registerModbus);
    ...
    public String getRegisterModbus() {
        return registerModbus;
    }

    public void setRegisterModbus(String registerModbus) {
        this.registerModbus = registerModbus;
    }
