...
public class AndroidDecoder implements IDecodable {
	...
	private void createRadioButton(final Gene root, LinearLayout view) {
		this.layoutAux = view;
		final ComboCodon codon = (ComboCodon) root.getCodon();
		TextView label = new TextView(this.context);
		label.setTag(R.id.fieldIsLabel, true);
		...
		BlockingOnUIRunnable actionRunnable = new BlockingOnUIRunnable(activity, new IBlockingOnUIRunnableListener()
		{
			public void runOnUIThread()
			{
				...
				group.setTag(R.id.fieldIsLabel, false);
				group.setTag(R.id.registerModBusTag, root.getRegisterModbus());
	...
	private void createSeekBar(final Gene root, LinearLayout view) {
		...
		BlockingOnUIRunnable actionRunnable = new BlockingOnUIRunnable(activity, new IBlockingOnUIRunnableListener()
		{
			public void runOnUIThread()
			{
				...
				seek.setTag(R.id.registerModBusTag, root.getRegisterModbus());
				seek.setTag(R.id.fieldIsLabel, false);
				LayoutParams params = new LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1 - codon.getWeight());
	...
	private void createInput(final Gene root, LinearLayout view) {
		this.layoutAux = view;
		final BaseCodon codon = root.getCodon();
		TextView label = new TextView(this.context);
		label.setTag(R.id.fieldIsLabel, true);
		...
		BlockingOnUIRunnable actionRunnable = new BlockingOnUIRunnable(activity, new IBlockingOnUIRunnableListener()
		{
			public void runOnUIThread()
			{
				...
				edit.setTag(R.id.fieldIsLabel, false);
				edit.setTag(R.id.registerModBusTag, root.getRegisterModbus());
				LayoutParams params = new LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1 - codon.getWeight());
				edit.setEms(5);
	...
	private void createComboBox(final Gene root, LinearLayout view) {
		this.layoutAux = view;
		final ComboCodon codon = (ComboCodon) root.getCodon();
		TextView label = new TextView(this.context);
		label.setTag(R.id.fieldIsLabel, true);
		...
		BlockingOnUIRunnable actionRunnable = new BlockingOnUIRunnable(activity, new IBlockingOnUIRunnableListener()
		{
			public void runOnUIThread()
			{
				...
				spinner.setTag(R.id.fieldIsLabel, false);
				spinner.setTag(R.id.registerModBusTag, root.getRegisterModbus());
	...
	private void createCheckBox(Gene root, LinearLayout view) {
		...
		cb.setTag(R.id.fieldIsLabel, false);
		cb.setTag(R.id.registerModBusTag, root.getRegisterModbus());
	...
	private void createButton(Gene root, LinearLayout view) {
		...
		label2.setText("18");
		label2.setTag(R.id.registerModBusTag, root.getRegisterModbus());
		label2.setTag(R.id.fieldIsLabel, false);
		params = new LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1 - codon.getWeight());
